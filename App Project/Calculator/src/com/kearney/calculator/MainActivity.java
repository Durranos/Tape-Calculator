...
/**
 * Android App: Tape Calculator
 * This app functions as a normal calculator except it maintains
 * each calculation that the users enters into the calculator
 * 
 * @author David
 * @version 0.0.1 ALPHA
 */
...
public class MainActivity extends Activity {	
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Calls the CalcButtons class which creates the calculator' buttons
		 * Passes in MainActivity Activity
		 */
		CalcButtons cB = new CalcButtons(this);
	}
	...
	public void onWindowFocusChanged(boolean hasFocus){
		scaleContents(this.findViewById(R.id.contents), this.findViewById(R.id.container));
	}
